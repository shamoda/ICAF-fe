...
class WorkshopCard extends Component {
    ...
    render() {
        ...
        const { currentEntries, totalPages, pageNumCss, currentPage, nextPage, prevPage, lastPage, firstPage } = this.props
        return (
            <div>
                {currentEntries.map((p) => (
                    <Card className="workshopeditor-card" body key={p.workshopId}>
                        <Row>
                            <Col>
